...
public class DateGather {
    ...
    public static class ItemModels extends ItemModelProvider {
        ...
        public ItemModels(PackOutput output, ExistingFileHelper existingFileHelper){
            this(output, DoomGreats.MODID, existingFileHelper);
        }

        @Override
        protected void registerModels() {
            Class<?> clazz = Item.class;
            if (ClassRegister.isRegistered(clazz)){
                ClassRegister.getRegisterObjects(clazz).forEach((name, registerObject) -> {
            ...
            if (ClassRegister.isRegistered(clazz)){
                ClassRegister.getRegisterObjects(clazz).forEach((name, registerObject) -> {
                    ...
                    if (object instanceof Block block) {
                        ...
                        cubeAll(blockName, ResourceLocation.fromNamespaceAndPath(DoomGreats.MODID, blockName));
                    }
                });
            }
        }
