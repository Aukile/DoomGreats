package com.ankrya.doomsgreats.client.shaber.model;
...
public class CosmicBakeModel implements BakedModel {
    ...
    public void renderItem(ItemStack stack, ItemDisplayContext transformType, PoseStack pStack, MultiBufferSource buffers, int packedLight, int packedOverlay) {
        ...
        for (int i = 0; i < 10; ++i) {
            TextureAtlasSprite sprite = Minecraft.getInstance().getTextureAtlas(InventoryMenu.BLOCK_ATLAS).apply(GJ.Easy.getResource("misc/cosmic_" + i));
