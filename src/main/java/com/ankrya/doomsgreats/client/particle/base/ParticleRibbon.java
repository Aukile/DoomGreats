...
public class ParticleRibbon extends AdvancedParticleBase {
    ...
    public void render(VertexConsumer buffer, Camera renderInfo, float partialTicks) {
        ...
        for(int var6 = 0; var6 < var5; ++var6) {
            ParticleComponent component = var4[var6];
        ...
        for(index = 0; index < this.positions.length - 1; ++index) {
            if (this.positions[index] != null && this.positions[index + 1] != null) {
                ...
                for(int var21 = 0; var21 < var43; ++var21) {
                    ParticleComponent component = var40[var21];
                ...
                HTool.ToMath.transform(vertices2[0], boxTranslate);
                HTool.ToMath.transform(vertices2[1], boxTranslate);
                boxTranslate = createTranslateMatrix((float)p2.x, (float)p2.y, (float)p2.z);
                HTool.ToMath.transform(vertices2[2], boxTranslate);
                HTool.ToMath.transform(vertices2[3], boxTranslate);
